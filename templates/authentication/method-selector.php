...
<div class="spada-auth-view" id="spada-view-methods" data-view="methods">
	...
	<div class="spada-method-list">
		...
		<button type="button" class="spada-method-btn is-active" id="spada-method-email" data-method="email">
		...
		<!-- Option 2: WhatsApp -->
		<button type="button" class="spada-method-btn" id="spada-method-whatsapp" data-method="whatsapp">
			<div class="spada-method-icon">
				<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
		...
		<!-- Option 3: SMS -->
		<button type="button" class="spada-method-btn" id="spada-method-sms" data-method="sms">
			<div class="spada-method-icon">
				<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
